...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_voyager(
    SET_MAC,        RGB_TOG,        TOGGLE_LAYER_COLOR,RGB_MODE_FORWARD,RGB_VAD,    RGB_VAI,                                        RGB_SPI,        RGB_SPD,        RGB_HUI,        RGB_HUD,        RGB_SAI,        RGB_SAD,        
    SET_LINUX,      KC_BRIGHTNESS_UP,KC_MEDIA_NEXT_TRACK,S_GUI_TAB, GUI_TAB,        KC_AUDIO_VOL_UP,                                KC_PSCR,        KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_BRIGHTNESS_DOWN,KC_MEDIA_PLAY_PAUSE,S_CTL_TAB,CTL_TAB,       KC_AUDIO_MUTE,                                  KC_SCRL,        KC_F5,          KC_F6,          KC_F7,          KC_F8,          KC_TRANSPARENT, 
