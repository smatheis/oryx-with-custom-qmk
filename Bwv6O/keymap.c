...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, MO(2),          LT(5, KC_P),    DE_Y,           MT(MOD_LSFT, KC_G),KC_J,                                           KC_X,           KC_W,           KC_K,           KC_COMMA,       OSM(MOD_LSFT),  KC_TRANSPARENT, 
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, MO(3),          DE_DLR,         LALT(KC_7),     LALT(KC_N),     LSFT(KC_EQUAL),                                 DE_PLUS,        DE_PERC,        DE_DQOT,        LSFT(KC_NONUS_HASH),DE_SCLN,        KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, LT(4, KC_SPACE),                                KC_TRANSPARENT, MO(3)
  ),
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, LGUI(KC_X),     LGUI(KC_C),     LGUI(KC_V),     KC_ENTER,                                       DE_COLN,        KC_7,           KC_8,           KC_9,           DE_SCLN,        KC_TRANSPARENT, 
                                                    MO(3),          LT(4, KC_SPACE),                                KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [3] = LAYOUT_voyager(
